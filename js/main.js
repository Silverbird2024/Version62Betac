...
if ($App.Main01 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main01","a",600,null);

} else {
};
if ($App.Main02 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main02","a",601,null);

} else {
};
if ($App.Main03 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main03","a",602,null);

} else {
};
if ($App.Main04 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main04","a",603,null);

} else {
};
if ($App.Main05 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main05","a",604,null);

} else {
};
if ($App.Main06 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main06","a",605,null);

} else {
};
if ($App.Main07 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main07","a",606,null);

} else {
};
if ($App.Main08 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main08","a",607,null);

} else {
};
if ($App.Main09 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main09","a",608,null);

} else {
};
if ($App.Main10 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main10","a",609,null);

} else {
};
if ($App.Main11 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main11","a",610,null);

} else {
};
if ($App.Main12 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main12","a",611,null);

} else {
};
if ($App.Main13 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main13","a",612,null);

} else {
};
if ($App.Main14 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main14","a",613,null);

} else {
};
if ($App.Main15 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main15","a",614,null);

} else {
};
if ($App.Main16 == "") {
neoGSheetsLoadCell($App.googleSheet,"Main16","a",615,null);

} else {
};};
$scope.Base_pageenter = function() {$App.M016x001 = localStorage.getItem("M016x001");
...
$scope.HideObject("reda","",0);
$scope.HideObject("redb","",0);
$scope.HideObject("redc","",0);
$scope.HideObject("redd","",0);
$scope.HideObject("rede","",0);
$scope.HideObject("redf","",0);
$scope.HideObject("redg","",0);
$scope.HideObject("redh","",0);
$App.basename = localStorage.getItem("basename");};
...
$App.Main17 = localStorage.getItem("Main17");
$App.Main18 = localStorage.getItem("Main18");};
$scope.SelectionM006x01q_pageenter = function() {$App.M006x001 = localStorage.getItem("M006x001");
$App.M006x001a = localStorage.getItem("M006x001a");};
...
$scope.PushButton48_click = function() {$scope.GotoPage( "mainEdit" );};
...
$scope.Circlea_click = function() {$scope.GotoPage( "SelectionM001x01" );};
$scope.Circleb_click = function() {$scope.GotoPage( "SelectionM002x01" );};
$scope.Circlec_click = function() {$scope.GotoPage( "SelectionM003x01" );};
$scope.Circled_click = function() {$scope.GotoPage( "SelectionM004x01" );};
$scope.Circlef_click = function() {$scope.GotoPage( "SelectionM007x01" );};
$scope.Circleh_click = function() {$scope.GotoPage( "SelectionM008x01" );};
$scope.Prompt07_click = function() {$scope.GotoPage( "SelectionM007x01" );};
$scope.Line07_click = function() {$scope.ObjectToFront("Short07");};
$scope.Line08_click = function() {$scope.ObjectToFront("Short08");};
$scope.PushButton125_click = function() {$scope.HideObject("reda","",0);
$scope.HideObject("redb","",0);
$scope.HideObject("redc","",0);
$scope.HideObject("redd","",0);
$scope.HideObject("rede","",0);
...
$scope.HideObject("redg","",0);
$scope.HideObject("redh","",0);};
$scope.PushButton123_click = function() {$scope.HideObject("redb","",0);};
$scope.redcb_click = function() {$scope.HideObject("redc","",0);};
$scope.PushButton126_click = function() {$scope.HideObject("redf","",0);};
$scope.PushButton127_click = function() {$scope.HideObject("rede","",0);};
$scope.PushButton128_click = function() {$scope.HideObject("redd","",0);};
$scope.PushButton129_click = function() {$scope.HideObject("redg","",0);};
$scope.PushButton130_click = function() {$scope.HideObject("redh","",0);};
$scope.PushButton132_click = function() {$scope.ShowObject("redb","",0);};
$scope.PushButton133_click = function() {$scope.ShowObject("redc","",0);};
$scope.PushButton134_click = function() {$scope.ShowObject("redf","",0);};
$scope.PushButton135_click = function() {$scope.ShowObject("rede","",0);};
$scope.PushButton136_click = function() {$scope.ShowObject("redd","",0);};
$scope.PushButton137_click = function() {$scope.ShowObject("redg","",0);};
$scope.PushButton138_click = function() {$scope.ShowObject("redh","",0);};
$scope.PushButton139_click = function() {$scope.GotoPage( "Main" );};
$scope.PushButton140_click = function() {$scope.GotoPage( "SelectionM014" );};
$scope.PushButton169_click = function() {$App.short = $App.M001x001a;};
$scope.PushButton171_click = function() {$App.short = $App.M002x001a;};
$scope.PushButton172_click = function() {$App.short = $App.M003x001a;};
$scope.PushButton173_click = function() {$App.short = $App.M004x001a;};
$scope.PushButton174_click = function() {$App.short = $App.M005x001a;};
$scope.PushButton175_click = function() {$App.short = $App.M006x001a;};
$scope.PushButton176_click = function() {$App.short = $App.M007x001a;};
$scope.PushButton177_click = function() {$App.short = $App.M008x001a;};
$scope.Headline205_click = function() {$scope.GotoPage( "SelectionM001x01" );};
$scope.Headline225_click = function() {$scope.GotoPage( "SelectionM003x01" );};
$scope.Headline226_click = function() {$scope.GotoPage( "SelectionM002x01" );};
$scope.Headline227_click = function() {$scope.GotoPage( "SelectionM007x01" );};
$scope.Headline233_click = function() {$scope.GotoPage( "SelectionM008x01" );};
$scope.Headline234_click = function() {$scope.GotoPage( "SelectionM005x01" );};
$scope.Headline235_click = function() {$scope.GotoPage( "SelectionM007x01" );};
$scope.Headline236_click = function() {$scope.GotoPage( "SelectionM006x01" );};
$scope.PushButton9_click = function() {$scope.HideObject("reda","",0);};
$scope.PushButton36_click = function() {$scope.ShowObject("reda","",0);};
});
...
$scope.PushButton142_click = function() {$scope.GotoPage( "SelectionM006x01q" );};
...
NeoApp.controller("SelectionM006x01q_Ctrl", function($scope,$rootScope,$route,$timeout,$filter,$window,$animate) {
$App.NAB.PageNumber = 12;
$App.NAB.PageID = "SelectionM006x01q";
...
$scope.PushButton168_click = function() {$scope.GotoPage( "Main" );};
...
$scope.PushButton170_click = function() {$scope.GotoPage( "Main" );};
...
$scope.PushButton113_click = function() {$scope.GotoPage( "Main" );};
...
$scope.PushButton114_click = function() {$scope.GotoPage( "Main" );};
});
...
$scope.PushButton115_click = function() {$scope.GotoPage( "Main" );};
});
...
$scope.PushButton116_click = function() {$scope.GotoPage( "Main" );};
});
...
$scope.PushButton27_click = function() {$scope.GotoPage( "Main" );};
...
$scope.PushButton28_click = function() {$scope.GotoPage( "Main" );};
...
$scope.PushButton33_click = function() {$scope.GotoPage( "Main" );};
